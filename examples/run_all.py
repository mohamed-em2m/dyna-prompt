...
def run_example():
    ...
    print(f"Schema attached: {rendered_md.response_schema.__name__ if rendered_md.response_schema else 'None'}")
    ...
    print(f"Schema: {rendered_toml.response_schema.__name__ if rendered_toml.response_schema else 'None'}")
    print()
